                            ...
                            <ul class="pl-9 mt-1 @if (!in_array(Request::segment(1), ['users'])) {{ 'hidden' }} @endif"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('users.farmers')) {{ '!text-indigo-500' }} @endif"
                                        href="{{ route('users.farmers') }}">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Farmers</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('users.buyers')) {{ '!text-indigo-500' }} @endif"
                                        href="{{ route('users.buyers') }}">
                                        <span
                                            class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Buyers</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
